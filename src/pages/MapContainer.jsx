...
const resources = [
    { id: 1, type: "government", position: [41.7627, -72.6739], name: "Hartford City Hall", address: "550 Main St, Hartford, CT 06103", website: "https://www.hartfordct.gov/" },
    { id: 2, type: "education", position: [41.7688, -72.6754], name: "Capital Community College", address: "950 Main St, Hartford, CT 06103", website: "https://www.capitalcc.edu/" },
    { id: 3, type: "medical", position: [41.7628, -72.6714], name: "Hartford Hospital", address: "80 Seymour St, Hartford, CT 06102", website: "https://hartfordhospital.org/" },
    { id: 4, type: "medical", position: [41.7675, -72.6932], name: "Connecticut Children's", address: "282 Washington St, Hartford, CT 06106", website: "https://www.connecticutchildrens.org/" },
    { id: 5, type: "housing", position: [41.7632, -72.6815], name: "Hartford Housing Authority", address: "180 Overlook Terrace, Hartford, CT 06106", website: "https://www.hartfordhousing.org/" },
    { id: 6, type: "housing", position: [41.7589, -72.6741], name: "Community Renewal Team", address: "555 Windsor St, Hartford, CT 06120", website: "https://www.crtct.org/" },
    { id: 7, type: "employment", position: [41.7663, -72.6834], name: "CT Department of Labor", address: "200 Folly Brook Blvd, Wethersfield, CT 06109", website: "https://www.ctdol.state.ct.us/" },
    { id: 8, type: "employment", position: [41.7695, -72.6721], name: "Career Resources Inc", address: "3580 Main St, Hartford, CT 06120", website: "https://www.crinc.org/" }
];
...
const MapPage = () => {
    ...
    const getIconForMarker = (item) => {
        switch(item.type) {
            case "government": return govIcon;
                        ...
                        <div className="bg-gray-900 border border-gray-700 rounded-lg p-6">
                            ...
                            <div className="mb-6">
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {["all", "government", "education", "medical", "housing", "employment"].map((type) => (
                                        <button
                                            key={type}
