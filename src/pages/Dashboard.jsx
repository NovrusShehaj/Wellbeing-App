...
import {
  getWellbeingScore,
  getNeighborhoodData,
} from "../services/WellbeingService.jsx";
import {
  Chart as ChartJS,
  CategoryScale,
  LinearScale,
    ...
    <div className="bg-black text-white min-h-screen">
      <div className="container mx-auto px-4 py-6 lg:py-10">
        ...
        <div className="text-center mb-8 lg:mb-12">
          ...
          <h2 className="text-blue-200 font-medium text-lg md:text-xl mt-[50px] text-center">
        ...
        <div className="bg-gray-900 border border-gray-700 rounded-lg p-4 sm:p-6 mb-6 lg:mb-10">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <label
              htmlFor="year"
              className="text-blue-200 font-medium text-sm sm:text-base"
            >
              Select Year:
            </label>
            <select
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 lg:mb-10">
          ...
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-4 sm:p-6 hover:border-blue-400 transition-all">
            <h2 className="text-lg sm:text-xl font-bold text-blue-400 mb-3 sm:mb-4">
              Annual Wellbeing Score
            </h2>
            {loading ? (
